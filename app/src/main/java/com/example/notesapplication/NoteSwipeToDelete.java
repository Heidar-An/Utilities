...
public class NoteSwipeToDelete extends ItemTouchHelper.SimpleCallback{

    private final noteRecyclerView mRecyclerAdapter;
    ...
    public NoteSwipeToDelete(noteRecyclerView recyclerAdapter){
        super(0, ItemTouchHelper.LEFT | ItemTouchHelper.RIGHT);
        mRecyclerAdapter = recyclerAdapter;
        mIcon = ContextCompat.getDrawable(mRecyclerAdapter.getContext(), R.drawable.delete_bin);
